...
export async function me(req: AuthRequest, res: Response, next: NextFunction) {
  try {
    const user = await prisma.user.findUnique({
      ...
      select: { id: true, name: true, email: true, role: true, emailVerified: true, avatarUrl: true, avatarFlagged: true, twoFactorEnabled: true, twoFactorMethod: true, onboardingDone: true, notifPrefs: true, createdAt: true },
    });
